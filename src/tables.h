...
/*extern  const   struct  flag_type       act_flags[];
 extern  const   struct  flag_type       ability_crusader_flags[];
 extern  const   struct  flag_type       ability_lich_flags[];
 ...
 extern  const   struct  flag_type       room_area_flags[];
 */
#define OBJ_VNUM  1
#define MOB_VNUM  2
...
extern const struct bit_type bitvector_type[];
extern const struct flag_type room_area_flags[];
extern const struct class_focus_mod class_focus[];
